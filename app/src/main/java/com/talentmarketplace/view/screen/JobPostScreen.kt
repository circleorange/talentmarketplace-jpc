        ...
        if (isMapVisible) {
            GoogleMapComponent(
                ...
                onLocationSelected = { latLng ->
                    jobPostViewModel.jobLocation.value = latLng
                    isMapVisible = false
                },
                jobLocation = jobPostViewModel.jobLocation
            )
        }
        else {
            if (isEditMode) {
            ...
            Button(
                ...
                Icon(Icons.Default.LocationOn, contentDescription = "Marker")
                Text(
                    text = if (jobPostViewModel.isPostOwner()) {
                        stringResource(R.string.btn_jobMarkLocation)
                    } else {
                        stringResource(R.string.btn_jobShowLocation)
                    }
                )
            }
            if (jobPostViewModel.isPostOwner()) {
                Row {
